...
const DBLeftSection = () => {
  return( 
    <div className="h-full py-12 flex flex-col bg-white opacity-90 backdrop-blur-md shadow-md min-w-210 w-300 gap-3">
    ...
    <div className="w-full h-12 border bg-white rounded-full flex items-center justify-center">
