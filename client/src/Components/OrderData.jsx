...
const OrderData = ({index,data,admin}) => {
  ...
  return (
    <motion.div {...staggerFadeInOut(index)} 
    className="w-full flex flex-col items-start justify-start px-3 py-2 
    border relative border-gray-300 bg-lightOverlay drop-shadow-md rounded-md gap-4">
      ...
      <div className='w-full flex items-center justify-between'>
        ...
        <div className='flex items-center gap-4'>
          <p className='flex items-center gap-1 text-textColor'>
            ...
            <span className='text-headingColor font-bold'>{data?.total}</span></p>
            ...
            {admin && (
              <div className='flex items-center justify-center gap-2'>
                ...
                capitalize border border-gray-300 px-2 py-[2px] rounded-md cursor-pointer`}
                >
                  Preparing
                </motion.p>
      ...
      <div className='flex items-center justify-start flex-wrap w-full'>
        <div className='flex items-center justify-center gap-4'>
          {data?.items && data.items.map((item,j)=>(
            <motion.div {...staggerFadeInOut(j)} key={j}
