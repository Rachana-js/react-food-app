...
import {MdShoppingCart} from "../assests/icons";
...
const Header = () => {
  ...
  <header className="fixed backdrop-blur-md z-50 inset-x-0 top-0 flex items-center justify-between px-12 md:px-20 py-6">
    ...
    <nav className="flex items-center justify-center gap-8">
        ...
        <> <div className="relative cursor-pointer" onMouseEnter={()=> setisMenu(true)}>
          ...
          {isMenu &&(
           ...
           {...slideTop}
            ...
            className="px-6 py-4 w-48 bg-white opacity-90 backdrop-blur-md rounded-md shadow-md absolute top-12 right-0 flex flex-col gap-4">
            ...
            onClick={signOut}
            className="group flex items-center justify-center px-3 py-2 shadow-md bg-gray-100 hover:bg-gray-200 gap-3">
        ...
        <>
        <NavLink to={"/login"}>
          <motion.button {...buttonClick} className="px-4 py-2 rounded-md shadow-md bg-white opacity-100
